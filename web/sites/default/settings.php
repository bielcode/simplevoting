 ...
 * @endcode
 */
$settings['hash_salt'] = 'lza6IdSkWgiHzI1kXa7TpoG11o_wcsPWv-9TJXdsO86MRLd4eeoR_ITLEf-x_VsfRPri2OsNuA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_WgbvmBUGXNbNKFSxxvNYlaOqEn8ZdRG16UFfEZpgHbjHw3jIMvUWRtCTEKGI7FvBu5GQLzgjIA/sync';

// Restringe os hosts aceitos pelo Drupal — obrigatório em produção.
$settings['trusted_host_patterns'] = [
...
// Sobrescritas de ambiente local (cache nulo, debug, etc.).
// Crie web/sites/default/settings.local.php a partir de example.settings.local.php.
